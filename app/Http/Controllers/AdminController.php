...
class AdminController extends Controller
{
    public function index()
    {
        ...
        // $pesanan = DB::table('table_transaksi')
        //     ->join('table_detail_transaksi', 'table_transaksi.no_pesanan', '=', 'table_detail_transaksi.no_psn')
        //     ->join('table_menu', 'table_detail_transaksi.id_menu', '=', 'table_menu.id')
        //     ->select('table_transaksi.*', 'table_detail_transaksi.*')
        ...
        return view('pages.admin.index', compact('pesanan'));
    }
