        ...
        <div class="inline-block min-w-full align-middle">
            ...
            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                    <td class="w-4 p-4">
                        <div class="max-w-sm p-4 overflow-hidden text-base font-medium text-gray-900 truncate xl:max-w-xs dark:text-white">
                            {{ $loop->iteration }}
                        </div>
                    </td>
                    <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
            
                        <img class="w-24 h-24 object-cover" src="{{asset('storage/' .$m->gambar)}}" alt="avatar">
                   
                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                    </td>
                    <td class="max-w-sm p-4 overflow-hidden text-base font-medium text-gray-900 truncate xl:max-w-xs dark:text-white">
                        {{$m->Menu}}
                    </td>
                    ...
                    <td class="p-4 space-x-2 whitespace-nowrap text-center">
                        <button type="button" data-modal-toggle="edit-user-modal-{{$m->id}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        ...
                        <button type="button" data-modal-toggle="delete-user-modal-{{ $m->id }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
                ...
                <x-admin.content.modalupdate id='{{$m->id}}' Menu='{{$m->Menu}}' harga='{{$m->harga}}' kategori='{{$m->kategori}}' gambar='{{$m->gambar}}' />
                @endforeach
