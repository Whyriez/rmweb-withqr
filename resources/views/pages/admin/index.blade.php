            ...
            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                        <img class="w-24 h-24 " src="{{asset('assets/img/makanan1.jpg')}}" alt="avatar">
                    ...
                    <td class="p-4 space-x-2 whitespace-nowrap text-center">
                        <button type="button" data-modal-toggle="edit-user-modal-{{$m->id}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                ...
                <x-admin.content.modalupdate id='{{$m->id}}' Menu='{{$m->Menu}}' harga='{{$m->harga}}' kategori='{{$m->kategori}}' />
